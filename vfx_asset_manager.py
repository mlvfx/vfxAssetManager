...
import vfxAssetManager.ui.style.palette as palette
reload(palette)

from vfxAssetManager.base.assets import Location, Asset
from vfxAssetManager.base import helpers
...
def main(*args):
    ...
    vfx_asset_manager.FILETYPES = filetypes
